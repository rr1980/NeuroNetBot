...
using System.ComponentModel;
    ...
    public class Neuron_2
    {
        ...
        public Neuron_2(int index, Layer initLayer, Neuron_2.ActivationType actType = ActivationType.SIGMOID, double bias = 0)
        {
            Index = index;
        ...
        public void AddConnection(Neuron_2 neuron, bool to, double weight = 0/*, double bias = 0*/)
        {
            Connection c;
    ...
    public class Connection
    {
        ...
        public readonly Neuron_2 toNeuron;
        public readonly Neuron_2 fromNeuron;
        public double Weight { get; set; }
        //public double Bias { get; set; }

        public Connection(Neuron_2 from, Neuron_2 to)
        {
            toNeuron = to;
            fromNeuron = from;
        ...
        public Connection(Neuron_2 from, Neuron_2 to, double weight)
        {
            toNeuron = to;
            fromNeuron = from;
            Weight = weight;
    ...
    public class Layer
    {
        ...
        public Neuron_2.ActivationType ActType { get; set; }
        public Neuron_2[] Neurons;
        ...
        public Layer(int index, int numNeurons, Neuron_2.ActivationType actTye = Neuron_2.ActivationType.SIGMOID, IEnumerable<double> initBias = null)
        {
            Index = index;
            NumNeurons = numNeurons;
            ActType = actTye;
            Neurons = new Neuron_2[NumNeurons];
            ...
            if (initBias != null)
            {
                ...
                {
                    Neurons[i] = new Neuron_2(i, this, ActType, initBias.ElementAt(i));
                }
            }
            ...
            else
            {
                for (int i = 0; i < NumNeurons; i++)
                {
                    Neurons[i] = new Neuron_2(i, this, ActType);
                }
            }
        }
        ...
        public void ConnectAllTo(Layer nextlayer, double defaultWeight = 0)
        {
            ...
            foreach (Neuron_2 n1 in Neurons)
            {
                foreach (Neuron_2 n2 in nextlayer.Neurons)
                {
    ...
    public class NeuralNet_2
    {
        ...
        public NeuralNet_2(int numLayers)
        {
            Layers = new Layer[numLayers];
            NumLayers = numLayers;
        }

        public NeuralNet_2(NetworkData network)
        {
        ...
        public NetworkData GetNetworkData()
        {
            ...
            foreach (Layer layer in Layers)
            {
                ...
                foreach (Neuron_2 neuron in layer.Neurons)
                {
    ...
    public class BackPropogationNetwork : NeuralNet_2
{
        ...
        {
            Layers[0] = new Layer(0, numInputs, Neuron_2.ActivationType.RAMP);
            Layers[2 + numHiddenLayers - 1] = new Layer(2 + numHiddenLayers - 1, numOutputs, Neuron_2.ActivationType.SIGMOID);
            for (int i = 0; i < numHiddenLayers; i++)
            {
                Layers[i + 1] = new Layer(i + 1, numHidden, Neuron_2.ActivationType.SIGMOID);
            }
        ...
        public List<List<List<double>>> BackPropogate(DataSet datain, double learninnRate, double momentum = 0)
        {
            ...
            {
                foreach (var n in currentLayer.Neurons)
                {
            ...
            while (currentLayer != Layers[InputIndex])
            {
                ...
                Neuron_2 n = currentLayer.Neurons[i];
